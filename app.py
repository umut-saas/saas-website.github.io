...
TRANSLATIONS = {
    "tr": {
        ...
        "free_plan_already_used": "Ücretsiz çıktı hakkınız zaten kullanıldı!",
    ...
    "en": {
        ...
        "free_plan_already_used": "Your free download has already been used!",
        "pro_plan_title": "Pro Plan — Startup",
    ...
    "de": {
        ...
        "free_plan_already_used": "Ihr kostenloser Download wurde bereits verwendet!",
        "pro_plan_title": "Pro Plan — Startup",
    ...
    "ru": {
        ...
        "free_plan_already_used": "Ваш бесплатный скачивание уже использовано!",
...
def keep_alive():
    while True:
        try:
            requests.get("https://saas-website-github-io.onrender.com/ping")
        except:
            pass
        time.sleep(180)
